...
public class Modeltoxic_helper_1_17<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ragemod", "modeltoxic_helper_1_17"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(77, 5).addBox(2.0F, -7.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 70)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 66).addBox(8.0F, -29.0F, -11.0F, 5.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 66)
		...
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(30, 53).addBox(-13.5F, -29.0F, 3.0F, 6.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(30, 53)
		...
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 31).addBox(22.075F, -5.65F, 33.75F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, -0.5236F));
		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 33).addBox(-21.725F, -5.65F, 35.725F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.4363F));
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(2.5F, -5.5F, 39.125F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(-4.5F, -5.5F, 39.125F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 11).addBox(-6.5F, -5.0F, 37.125F,
								13.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 43).addBox(-5.5F, -34.0F, 13.625F, 11.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
