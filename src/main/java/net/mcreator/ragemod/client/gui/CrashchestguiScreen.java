...
public class CrashchestguiScreen extends AbstractContainerScreen<CrashchestguiMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CrashchestguiScreen(CrashchestguiMenu container, Inventory inventory, Component text) {
