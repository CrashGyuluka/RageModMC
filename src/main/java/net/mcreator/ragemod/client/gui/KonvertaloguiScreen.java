...
public class KonvertaloguiScreen extends AbstractContainerScreen<KonvertaloguiMenu> {
	...
	public KonvertaloguiScreen(KonvertaloguiMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 108, this.topPos + 63, 60, 20, new TextComponent("Convert"), e -> {
			if (true) {
				RagemodMod.PACKET_HANDLER.sendToServer(new KonvertaloguiButtonMessage(0, x, y, z));
				KonvertaloguiButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
