...
public class Rageflylit2Renderer extends MobRenderer<Rageflylit2Entity, Modelragefly<Rageflylit2Entity>> {
	public Rageflylit2Renderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<Rageflylit2Entity, Modelragefly<Rageflylit2Entity>>(this) {
			@Override
