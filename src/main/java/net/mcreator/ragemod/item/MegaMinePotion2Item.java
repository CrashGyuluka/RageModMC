...
public class MegaMinePotion2Item extends Item {
	public MegaMinePotion2Item() {
		super(new Item.Properties().tab(RagemodModTabs.TAB_ERCEK).stacksTo(16).rarity(Rarity.COMMON)
				.food((new FoodProperties.Builder()).nutrition(0).saturationMod(0f).alwaysEat()
						...
						.build()));
		setRegistryName("longer_megamine_potion");
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		MegaMinePotion2FoodEatenProcedure.execute(entity);
