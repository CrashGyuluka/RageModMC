...
public class SavasobszidianBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savasobszidian")
	public static final Block block = null;

	public SavasobszidianBlock(RagemodModElements instance) {
		super(instance, 110);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("savasobszidian");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savasobszidian_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savasobszidian"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savasobszidian"), configuredFeature);
		}
	}
