...
public class PolishedhegyikowallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:polishedhegyikowall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedhegyikowall");
		}
