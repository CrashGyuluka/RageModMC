...
public class Ragefapr3Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:red_ragewood_pressure_plate")
	public static final Block block = null;

	public Ragefapr3Block(RagemodModElements instance) {
		super(instance, 350);
	}
