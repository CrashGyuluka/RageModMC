...
public class SavashomokkopirosBlock extends Block {
	public SavashomokkopirosBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.SAND).strength(1f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
