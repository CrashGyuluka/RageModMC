...
public class Hangingalienoff1Block extends Block {
	public Hangingalienoff1Block() {
		super(Block.Properties.of(Material.PLANT).sound(SoundType.GRASS).strength(0f, 0f).lightLevel(s -> 0).noCollission().speedFactor(1.1f)
				.jumpFactor(1.1f).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		Hangingalienoff1OnBlockRightClickedProcedure.execute(world, x, y, z);
