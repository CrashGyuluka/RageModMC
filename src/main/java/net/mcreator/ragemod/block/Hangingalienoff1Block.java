...
import net.mcreator.ragemod.procedures.Hangingalienoff1OnBlockRightClickedProcedure;
...
public class Hangingalienoff1Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hangingalienoff_1")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0)
					.doesNotBlockMovement().speedFactor(1.1f).jumpFactor(1.1f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("hangingalienoff_1");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HangingalienplantBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HangingalienplantBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Hangingalienoff1OnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:hangingalienoff_1_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 14)).range(75)
					.square().func_242731_b(28);
			event.getRegistry().register(feature.setRegistryName("hangingalienoff_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:hangingalienoff_1"), configuredFeature);
		}
	}
	@SubscribeEvent
