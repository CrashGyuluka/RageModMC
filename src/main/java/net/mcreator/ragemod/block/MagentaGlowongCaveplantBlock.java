...
public class MagentaGlowongCaveplantBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:magenta_glowong_caveplant")
	public static final Block block = null;

	public MagentaGlowongCaveplantBlock(RagemodModElements instance) {
		super(instance, 1334);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magenta_glowong_caveplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:magenta_glowong_caveplant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(MagentacaveplantBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MagentacaveplantBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			MagentaGlowongCaveplantPlantRightClickedProcedure.executeProcedure(Stream
