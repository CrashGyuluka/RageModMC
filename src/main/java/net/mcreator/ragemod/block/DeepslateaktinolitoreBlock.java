...
public class DeepslateaktinolitoreBlock extends RagemodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:deepslateaktinolitore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("deepslateaktinolitore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:deepslateaktinolitore"), configuredFeature);
		}
	}
