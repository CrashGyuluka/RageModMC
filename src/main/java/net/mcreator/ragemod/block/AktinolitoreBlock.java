...
public class AktinolitoreBlock extends RagemodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:aktinolitore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("aktinolitore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:aktinolitore"), configuredFeature);
		}
	}
	@SubscribeEvent
