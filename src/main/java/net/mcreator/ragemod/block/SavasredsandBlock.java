...
public class SavasredsandBlock extends FallingBlock {
	public SavasredsandBlock() {
		super(Block.Properties.of(Material.DIRT).sound(SoundType.SAND).strength(1f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
