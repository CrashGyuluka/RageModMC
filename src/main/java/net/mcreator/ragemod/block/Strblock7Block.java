...
public class Strblock7Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:strblock_7")
	public static final Block block = null;

	public Strblock7Block(RagemodModElements instance) {
		super(instance, 1416);
	}
