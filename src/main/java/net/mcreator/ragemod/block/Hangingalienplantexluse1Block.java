...
public class Hangingalienplantexluse1Block extends RagemodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hangingalienplantexluse_1");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:hangingalienplantexluse_1_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 18)).range(75)
					.square().func_242731_b(30);
			event.getRegistry().register(feature.setRegistryName("hangingalienplantexluse_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:hangingalienplantexluse_1"), configuredFeature);
		}
	}
