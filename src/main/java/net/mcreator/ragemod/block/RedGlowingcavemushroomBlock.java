...
public class RedGlowingcavemushroomBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:red_glowingcavemushroom")
	public static final Block block = null;

	public RedGlowingcavemushroomBlock(RagemodModElements instance) {
		super(instance, 1526);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_glowingcavemushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:red_glowingcavemushroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RedCavemushroomBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedCavemushroomBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			RedGlowingcavemushroomPlantRightClickedProcedure.executeProcedure(Stream
