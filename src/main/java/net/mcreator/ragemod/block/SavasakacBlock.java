...
public class SavasakacBlock extends RagemodModElements.ModElement {
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.ACACIA_LOG)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savasakac_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savasakac"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savasakac"), configuredFeature);
		}
	}
	@SubscribeEvent
