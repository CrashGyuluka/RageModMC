		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!AliendripstonetopdevAdditionalGenerationConditionProcedure.executeProcedure(Stream
			...
			event.getRegistry().register(feature.setRegistryName("aliendripstonetopdev"));
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.BAD_OMEN, 5, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.STONE)
					.hardnessAndResistance(3f, 1f).setLightLevel(s -> 5));
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			if (worldIn instanceof IWorld) {
				...
				additionalCondition = AliendripstonetopdevAdditionalPlacinggrowthConditionProcedure.executeProcedure(Stream
						.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
								new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			AliendripstonetopdevUpdateTickProcedure.executeProcedure(Stream
