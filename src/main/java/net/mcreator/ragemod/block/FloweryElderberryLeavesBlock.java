...
public class FloweryElderberryLeavesBlock extends RagemodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Elderberrxstage3OnBlockRightClickedProcedure.executeProcedure(Stream
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("flowery_elderberry_leaves");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Flowery Elderberry Leaves");
		}
