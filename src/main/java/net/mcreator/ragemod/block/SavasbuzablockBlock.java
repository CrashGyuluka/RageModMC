...
public class SavasbuzablockBlock extends Block {
	public SavasbuzablockBlock() {
		super(Block.Properties.of(Material.GRASS).sound(SoundType.GRAVEL).strength(1f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
