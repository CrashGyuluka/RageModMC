...
public class RagingvinesBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:raging_growth")
	public static final Block block = null;
	public RagingvinesBlock(RagemodModElements instance) {
		super(instance, 99);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:raging_growth_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("raging_growth"));
