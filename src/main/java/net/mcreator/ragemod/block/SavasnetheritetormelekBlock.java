...
public class SavasnetheritetormelekBlock extends Block {
	public SavasnetheritetormelekBlock() {
		super(Block.Properties.of(Material.METAL).sound(SoundType.ANCIENT_DEBRIS).strength(2f, 10f).lightLevel(s -> 0).requiresCorrectToolForDrops()
