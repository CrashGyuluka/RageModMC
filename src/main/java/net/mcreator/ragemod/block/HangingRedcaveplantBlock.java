...
public class HangingRedcaveplantBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hanging_redcaveplant")
	public static final Block block = null;

	public HangingRedcaveplantBlock(RagemodModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hanging_redcaveplant");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			HangingRedcaveplantOnBlockRightClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
