...
public class HangingGlowingRedCavestoneBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hanging_glowing_red_cavestone")
	public static final Block block = null;

	public HangingGlowingRedCavestoneBlock(RagemodModElements instance) {
		super(instance, 1544);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(HangingRedcaveplantBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HangingRedcaveplantBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			HangingGlowingRedCavestoneOnBlockRightClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
