...
public class Hangingalienplant3Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hangingalienplant_3")
	public static final Block block = null;
	public Hangingalienplant3Block(RagemodModElements instance) {
		super(instance, 1297);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hangingalienplant_3");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:hangingalienplant_3_match"),
			...
			event.getRegistry().register(feature.setRegistryName("hangingalienplant_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:hangingalienplant_3"), configuredFeature);
		}
	}
	@SubscribeEvent
