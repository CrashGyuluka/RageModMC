...
public class SeqAir1Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:seq_air_1")
	public static final Block block = null;

	public SeqAir1Block(RagemodModElements instance) {
		super(instance, 1401);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			SeqBiomeProc1Procedure.executeProcedure(Stream
