...
public class BlueglowingcavemushroomBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:blueglowingcavemushroom")
	public static final Block block = null;

	public BlueglowingcavemushroomBlock(RagemodModElements instance) {
		super(instance, 1304);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blueglowingcavemushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:blueglowingcavemushroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(BlueCavemushroomBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlueCavemushroomBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			BlueCavemushroomPlantRightClickedProcedure.executeProcedure(Stream
