...
public class MarokriksaLeavesBlock extends RagemodModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("marokriksa_leaves"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("marokriksa_leaves");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Marokriksa Leaves");
		}
