...
public class RobtaiFenceBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:robtai_fence")
	public static final Block block = null;

	public RobtaiFenceBlock(RagemodModElements instance) {
		super(instance, 343);
	}
