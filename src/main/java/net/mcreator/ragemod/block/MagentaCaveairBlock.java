...
public class MagentaCaveairBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:magenta_caveair")
	public static final Block block = null;

	public MagentaCaveairBlock(RagemodModElements instance) {
		super(instance, 1300);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			MagentaCaveairproc2Procedure.executeProcedure(Stream
