...
import net.mcreator.ragemod.procedures.HangingBlueCaveplantOnBlockRightClickedProcedure;
...
import net.mcreator.ragemod.particle.BlueCaveparticleParticle;
...
public class HangingBlueCaveplantBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hanging_blue_caveplant")
	public static final Block block = null;

	public HangingBlueCaveplantBlock(RagemodModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0)
					.doesNotBlockMovement().speedFactor(0.9f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("hanging_blue_caveplant");
		}
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			if (worldIn instanceof IWorld) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				return AliendripstonetopdevAdditionalPlacinggrowthConditionProcedure.executeProcedure(Stream
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			HangingBlueCaveplantBlockAddedProcedure.executeProcedure(Stream
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 2; ++l) {
					...
					world.addParticle(BlueCaveparticleParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			HangingBlueCaveplantOnBlockRightClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
