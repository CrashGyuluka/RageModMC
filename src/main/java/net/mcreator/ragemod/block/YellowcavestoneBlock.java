...
public class YellowcavestoneBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:yellowcavestone")
	public static final Block block = null;

	public YellowcavestoneBlock(RagemodModElements instance) {
		super(instance, 227);
	}
