...
public class SavasszenercBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savasszenerc")
	public static final Block block = null;
	public SavasszenercBlock(RagemodModElements instance) {
		super(instance, 321);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savasszenerc_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savasszenerc"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savasszenerc"), configuredFeature);
		}
	}
	@SubscribeEvent
