...
public class SavascryobszidianBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savascryobszidian")
	public static final Block block = null;
	public SavascryobszidianBlock(RagemodModElements instance) {
		super(instance, 344);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("savascryobszidian");
		}
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.CRYING_OBSIDIAN)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savascryobszidian_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savascryobszidian"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savascryobszidian"), configuredFeature);
		}
	}
	@SubscribeEvent
