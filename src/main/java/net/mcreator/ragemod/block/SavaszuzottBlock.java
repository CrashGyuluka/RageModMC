...
public class SavaszuzottBlock extends Block {
	public SavaszuzottBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(0.5f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
