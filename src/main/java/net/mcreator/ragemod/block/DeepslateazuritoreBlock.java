...
public class DeepslateazuritoreBlock extends RagemodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("deepslateazuritore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:deepslateazuritore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("deepslateazuritore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:deepslateazuritore"), configuredFeature);
		}
	}
