...
public class Haningalienplant5Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:haningalienplant_5")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("haningalienplant_5");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:haningalienplant_5_match"),
			...
			event.getRegistry().register(feature.setRegistryName("haningalienplant_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:haningalienplant_5"), configuredFeature);
		}
	}
	@SubscribeEvent
