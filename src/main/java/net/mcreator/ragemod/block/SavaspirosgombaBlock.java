...
public class SavaspirosgombaBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savaspirosgomba")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.NETHER_PLANTS).sound(SoundType.WART).hardnessAndResistance(1f, 5f).setLightLevel(s -> 0)
					.harvestLevel(3).harvestTool(ToolType.HOE).setRequiresTool().slipperiness(0.7999999999999999f));
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savaspirosgomba_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savaspirosgomba"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savaspirosgomba"), configuredFeature);
		}
	}
