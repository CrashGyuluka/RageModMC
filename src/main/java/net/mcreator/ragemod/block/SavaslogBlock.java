...
public class SavaslogBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savaslog")
	public static final Block block = null;
	public SavaslogBlock(RagemodModElements instance) {
		super(instance, 283);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savaslog_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savaslog"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savaslog"), configuredFeature);
		}
	}
	@SubscribeEvent
