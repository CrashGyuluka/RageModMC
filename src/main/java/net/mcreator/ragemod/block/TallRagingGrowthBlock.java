...
public class TallRagingGrowthBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:tall_raging_growth")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tall_raging_growth"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:tall_raging_growth"), configuredFeature);
		}
	}
