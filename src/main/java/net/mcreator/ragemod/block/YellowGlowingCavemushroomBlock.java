...
public class YellowGlowingCavemushroomBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:yellow_glowing_cavemushroom")
	public static final Block block = null;

	public YellowGlowingCavemushroomBlock(RagemodModElements instance) {
		super(instance, 1310);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("yellow_glowing_cavemushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:yellow_glowing_cavemushroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(YellowcavemushroomBlock.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(YellowcavemushroomBlock.block));
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			YellowGlowingCavemushroomPlantRightClickedProcedure.executeProcedure(Stream
