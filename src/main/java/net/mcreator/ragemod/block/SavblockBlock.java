...
public class SavblockBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savblock")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 400f).setLightLevel(s -> 0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().slipperiness(0.9f));
			setRegistryName("savblock");
		}
