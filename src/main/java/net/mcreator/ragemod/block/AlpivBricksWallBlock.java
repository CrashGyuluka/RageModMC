...
public class AlpivBricksWallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:alpiv_bricks_wall")
	public static final Block block = null;

	public AlpivBricksWallBlock(RagemodModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("alpiv_bricks_wall");
		}
