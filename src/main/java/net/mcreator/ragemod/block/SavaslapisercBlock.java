...
public class SavaslapisercBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savaslapiserc")
	public static final Block block = null;
	public SavaslapisercBlock(RagemodModElements instance) {
		super(instance, 362);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savaslapiserc_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savaslapiserc"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savaslapiserc"), configuredFeature);
		}
	}
	@SubscribeEvent
