...
public class SavasbazaltBlock extends Block {
	public SavasbazaltBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.BASALT).strength(1f, 10f).lightLevel(s -> 0).requiresCorrectToolForDrops()
