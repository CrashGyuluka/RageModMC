...
public class SavassmaragdercBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savassmaragderc")
	public static final Block block = null;
	public SavassmaragdercBlock(RagemodModElements instance) {
		super(instance, 363);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("savassmaragderc");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savassmaragderc_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savassmaragderc"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savassmaragderc"), configuredFeature);
		}
	}
	@SubscribeEvent
