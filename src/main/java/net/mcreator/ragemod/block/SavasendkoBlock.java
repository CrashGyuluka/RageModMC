...
public class SavasendkoBlock extends Block {
	public SavasendkoBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(1f, 1f).lightLevel(s -> 0).requiresCorrectToolForDrops()
