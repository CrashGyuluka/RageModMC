...
public class PurplehydrangeaBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:purplehydrangea")
	public static final Block block = null;
	public PurplehydrangeaBlock(RagemodModElements instance) {
		super(instance, 193);
