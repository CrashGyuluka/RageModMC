...
public class DeepslateadularoreBlock extends RagemodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:deepslateadularore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("deepslateadularore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:deepslateadularore"), configuredFeature);
		}
	}
