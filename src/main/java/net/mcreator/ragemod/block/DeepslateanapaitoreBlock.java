...
public class DeepslateanapaitoreBlock extends RagemodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:deepslate_anapait_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("deepslate_anapait_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:deepslate_anapait_ore"), configuredFeature);
		}
	}
