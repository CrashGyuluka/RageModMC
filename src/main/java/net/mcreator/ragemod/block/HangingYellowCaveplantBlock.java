...
import net.mcreator.ragemod.procedures.HangingYellowCaveplantOnBlockRightClickedProcedure;
...
public class HangingYellowCaveplantBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hanging_yellow_caveplant")
	public static final Block block = null;

	public HangingYellowCaveplantBlock(RagemodModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hanging_yellow_caveplant");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			HangingYellowCaveplantOnBlockRightClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
