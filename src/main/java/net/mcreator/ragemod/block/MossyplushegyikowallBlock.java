...
public class MossyplushegyikowallBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:mossyplushegyikowall")
	public static final Block block = null;
	public MossyplushegyikowallBlock(RagemodModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossyplushegyikowall");
		}
