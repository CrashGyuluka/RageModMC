...
public class SavasbedrockBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savasbedrock")
	public static final Block block = null;
	public SavasbedrockBlock(RagemodModElements instance) {
		super(instance, 316);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savasbedrock_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savasbedrock"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savasbedrock"), configuredFeature);
		}
	}
	@SubscribeEvent
