...
public class SvaskekgombaBlock extends Block {
	public SvaskekgombaBlock() {
		super(Block.Properties.of(Material.STONE).sound(SoundType.WART_BLOCK).strength(1f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
