...
public class RageiumBrickStairsBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:rageium_brick_stairs")
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(4f, 100f)
					.setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().slipperiness(0.7f)).getDefaultState(),
					Block.Properties.create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(4f, 100f).setLightLevel(s -> 0)
