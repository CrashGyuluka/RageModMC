...
public class RageiumBrickStairsBlock extends StairBlock {
	public RageiumBrickStairsBlock() {
		super(() -> new Block(Block.Properties.of(Material.METAL).sound(SoundType.NETHERITE_BLOCK).strength(4f, 100f).lightLevel(s -> 0)
				.requiresCorrectToolForDrops().friction(0.7f).dynamicShape()).defaultBlockState(),
				Block.Properties.of(Material.METAL).sound(SoundType.NETHERITE_BLOCK).strength(4f, 100f).lightLevel(s -> 0)
						.requiresCorrectToolForDrops().friction(0.7f).dynamicShape());
