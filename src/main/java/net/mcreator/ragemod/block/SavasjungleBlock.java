...
public class SavasjungleBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:savasjungle")
	public static final Block block = null;

	public SavasjungleBlock(RagemodModElements instance) {
		super(instance, 133);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:savasjungle_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("savasjungle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:savasjungle"), configuredFeature);
		}
	}
