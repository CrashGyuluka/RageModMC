...
public class Ragefaslab2Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:ragefaslab_2")
	public static final Block block = null;
	public Ragefaslab2Block(RagemodModElements instance) {
		super(instance, 97);
	}
