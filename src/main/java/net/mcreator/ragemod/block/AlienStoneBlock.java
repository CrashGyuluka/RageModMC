...
public class AlienStoneBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:alien_stone")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:alien_stone_match"), () -> CustomRuleTest.codec);
