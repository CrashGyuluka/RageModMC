...
public class RedCavestoneBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:red_cavestone")
	public static final Block block = null;

	public RedCavestoneBlock(RagemodModElements instance) {
		super(instance, 201);
	}
