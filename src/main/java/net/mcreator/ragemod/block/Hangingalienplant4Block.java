...
public class Hangingalienplant4Block extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:hangingalienplant_4")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hangingalienplant_4");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragemod:hangingalienplant_4_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 9)).range(75)
					.square().func_242731_b(26);
			event.getRegistry().register(feature.setRegistryName("hangingalienplant_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragemod:hangingalienplant_4"), configuredFeature);
		}
	}
