...
public class RageiumBricksPressurePlateBlock extends RagemodModElements.ModElement {
	@ObjectHolder("ragemod:rageium_bricks_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.MOBS, Block.Properties.create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(4f, 100f)
					.setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().slipperiness(0.7f));
