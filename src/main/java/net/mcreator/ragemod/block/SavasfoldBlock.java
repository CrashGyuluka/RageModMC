...
public class SavasfoldBlock extends Block {
	public SavasfoldBlock() {
		super(Block.Properties.of(Material.DIRT).sound(SoundType.GRAVEL).strength(0.5f, 5f).lightLevel(s -> 0).requiresCorrectToolForDrops()
