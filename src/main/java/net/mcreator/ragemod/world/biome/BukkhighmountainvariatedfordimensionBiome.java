...
public class BukkhighmountainvariatedfordimensionBiome extends RagemodModElements.ModElement {
	public static Biome biome;
	public BukkhighmountainvariatedfordimensionBiome(RagemodModElements instance) {
		super(instance, 1228);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(RagemiteEntity.entity, 5, 1, 2));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(3f).scale(2f).temperature(0.2f)
						.downfall(0.6f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("ragemod:bukkhighmountainvariatedfordimension"));
			}
		}
	}
	@Override
