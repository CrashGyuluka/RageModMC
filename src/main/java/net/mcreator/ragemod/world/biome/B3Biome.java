...
public class B3Biome extends RagemodModElements.ModElement {
	public static Biome biome;
	public B3Biome(RagemodModElements instance) {
		super(instance, 414);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10066432).setWaterColor(-10092391).setWaterFogColor(-6750106)
						.withSkyColor(-10066432).withFoliageColor(-3355393).withGrassColor(-103).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.CYAN_CONCRETE_POWDER.getDefaultState(),
								Blocks.BRICKS.getDefaultState(), Blocks.BRICKS.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.GIANT, 1, 1, 1));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.HUSK, 2, 2, 3));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.LLAMA, 1, 1, 1));
				...
				event.getRegistry().register(biome.setRegistryName("ragemod:b_3"));
			}
		}
	}
	@Override
