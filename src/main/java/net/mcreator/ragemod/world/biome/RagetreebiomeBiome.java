...
public class RagetreebiomeBiome extends RagemodModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-15058084).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-15058084).withFoliageColor(10387789).withGrassColor(-10092544)
						.setParticle(new ParticleEffectAmbience(RagefallingtreeParticle.particle, 0.004f)).build();
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(0.4f).scale(0.4f)
