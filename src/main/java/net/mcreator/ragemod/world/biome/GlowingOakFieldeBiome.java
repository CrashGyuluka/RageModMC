...
public class GlowingOakFieldeBiome extends RagemodModElements.ModElement {
	public static Biome biome;

	public GlowingOakFieldeBiome(RagemodModElements instance) {
		super(instance, 1386);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-12030686).withGrassColor(-5405137).build();
				...
				event.getRegistry().register(biome.setRegistryName("ragemod:glowing_oak_field"));
			}
		}
	}
