...
public class Glowingforestflow7Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow7Feature FEATURE = (Glowingforestflow7Feature) new Glowingforestflow7Feature()
			.setRegistryName("ragemod:glowingforestflow_7");
	...
	public Glowingforestflow7Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir7"));
		if (template == null)
			return false;
