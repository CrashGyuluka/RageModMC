...
public class Elderberrybush1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Elderberrybush1Feature FEATURE = (Elderberrybush1Feature) new Elderberrybush1Feature()
			.setRegistryName("ragemod:elderberrybush_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "elderberry_bush1"));
		if (template == null)
			return false;
