...
public class Str2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str2Feature FEATURE = (Str2Feature) new Str2Feature().setRegistryName("ragemod:str_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "str2"));
		if (template == null)
			return false;
