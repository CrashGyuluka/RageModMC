...
public class Richdesertkak2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Richdesertkak2Feature FEATURE = (Richdesertkak2Feature) new Richdesertkak2Feature()
			.setRegistryName("ragemod:richdesertkak_2");
