...
public class KizukrawithoutFeature extends Feature<NoneFeatureConfiguration> {
	public static final KizukrawithoutFeature FEATURE = (KizukrawithoutFeature) new KizukrawithoutFeature().setRegistryName("ragemod:kizukrawithout");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "kizukra_without"));
		if (template == null)
			return false;
