...
public class Elderberrybush5Feature extends Feature<NoneFeatureConfiguration> {
	public static final Elderberrybush5Feature FEATURE = (Elderberrybush5Feature) new Elderberrybush5Feature()
			.setRegistryName("ragemod:elderberrybush_5");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "elderberry_bush5"));
		if (template == null)
			return false;
