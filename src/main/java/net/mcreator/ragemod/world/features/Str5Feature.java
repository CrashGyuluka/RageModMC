...
public class Str5Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str5Feature FEATURE = (Str5Feature) new Str5Feature().setRegistryName("ragemod:str_5");
	...
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("deep_cold_ocean"), new ResourceLocation("frozen_ocean"),
			new ResourceLocation("warm_ocean"), new ResourceLocation("deep_warm_ocean"), new ResourceLocation("ice_spikes"),
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "str5"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 169) {
