...
public class Glowingforestfol1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestfol1Feature FEATURE = (Glowingforestfol1Feature) new Glowingforestfol1Feature()
			.setRegistryName("ragemod:glowingforestfol_1");
	...
	public Glowingforestfol1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_paf1"));
		if (template == null)
			return false;
