...
public class Str9Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str9Feature FEATURE = (Str9Feature) new Str9Feature().setRegistryName("ragemod:str_9");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "str9"));
		if (template == null)
			return false;
