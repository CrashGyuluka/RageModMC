...
public class Oreplus4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oreplus4Feature FEATURE = (Oreplus4Feature) new Oreplus4Feature().setRegistryName("ragemod:oreplus_4");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "oreplus04"));
		if (template == null)
			return false;
