...
public class PortaligniterfinderstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final PortaligniterfinderstrFeature FEATURE = (PortaligniterfinderstrFeature) new PortaligniterfinderstrFeature()
			.setRegistryName("ragemod:portaligniterfinderstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public PortaligniterfinderstrFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "portal_finder_str1"));
		if (template == null)
			return false;
