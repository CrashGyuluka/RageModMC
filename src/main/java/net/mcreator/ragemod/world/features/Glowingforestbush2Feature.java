...
public class Glowingforestbush2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestbush2Feature FEATURE = (Glowingforestbush2Feature) new Glowingforestbush2Feature()
			.setRegistryName("ragemod:glowingforestbush_2");
	...
	public Glowingforestbush2Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_bush1"));
		if (template == null)
			return false;
