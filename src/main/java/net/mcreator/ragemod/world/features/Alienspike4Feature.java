...
public class Alienspike4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienspike4Feature FEATURE = (Alienspike4Feature) new Alienspike4Feature().setRegistryName("ragemod:alienspike_4");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_spike4"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 750000) {
			boolean anyPlaced = false;
			int count = context.random().nextInt(6) + 4;
