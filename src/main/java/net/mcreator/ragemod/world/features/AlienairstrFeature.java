...
public class AlienairstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final AlienairstrFeature FEATURE = (AlienairstrFeature) new AlienairstrFeature().setRegistryName("ragemod:alienairstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public AlienairstrFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_air_str"));
		if (template == null)
			return false;
