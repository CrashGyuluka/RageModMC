...
public class Richdesertkak3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Richdesertkak3Feature FEATURE = (Richdesertkak3Feature) new Richdesertkak3Feature()
			.setRegistryName("ragemod:richdesertkak_3");
