...
public class Elderberrybush4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Elderberrybush4Feature FEATURE = (Elderberrybush4Feature) new Elderberrybush4Feature()
			.setRegistryName("ragemod:elderberrybush_4");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "elderberry_bush4"));
		if (template == null)
			return false;
