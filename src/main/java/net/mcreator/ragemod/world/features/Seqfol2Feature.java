...
public class Seqfol2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Seqfol2Feature FEATURE = (Seqfol2Feature) new Seqfol2Feature().setRegistryName("ragemod:seqfol_2");
