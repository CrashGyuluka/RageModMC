...
public class Glowingoaktree2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingoaktree2Feature FEATURE = (Glowingoaktree2Feature) new Glowingoaktree2Feature()
			.setRegistryName("ragemod:glowingoaktree_2");
