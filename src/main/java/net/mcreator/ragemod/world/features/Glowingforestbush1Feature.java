...
public class Glowingforestbush1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestbush1Feature FEATURE = (Glowingforestbush1Feature) new Glowingforestbush1Feature()
			.setRegistryName("ragemod:glowingforestbush_1");
	...
	public Glowingforestbush1Feature() {
