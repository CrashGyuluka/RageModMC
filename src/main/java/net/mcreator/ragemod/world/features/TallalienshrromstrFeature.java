...
public class TallalienshrromstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final TallalienshrromstrFeature FEATURE = (TallalienshrromstrFeature) new TallalienshrromstrFeature()
			.setRegistryName("ragemod:tallalienshrromstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public TallalienshrromstrFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "tall_alien_shroom"));
		if (template == null)
			return false;
