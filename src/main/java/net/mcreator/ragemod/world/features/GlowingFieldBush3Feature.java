...
public class GlowingFieldBush3Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldBush3Feature FEATURE = (GlowingFieldBush3Feature) new GlowingFieldBush3Feature()
			.setRegistryName("ragemod:glowing_field_bush_3");
	...
	public GlowingFieldBush3Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_bush3"));
		if (template == null)
			return false;
