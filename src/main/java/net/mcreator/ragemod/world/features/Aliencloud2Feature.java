...
public class Aliencloud2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Aliencloud2Feature FEATURE = (Aliencloud2Feature) new Aliencloud2Feature().setRegistryName("ragemod:aliencloud_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_cloud2"));
		if (template == null)
			return false;
