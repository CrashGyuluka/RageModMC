...
public class Oreplus1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oreplus1Feature FEATURE = (Oreplus1Feature) new Oreplus1Feature().setRegistryName("ragemod:oreplus_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "oreplus01"));
		if (template == null)
			return false;
