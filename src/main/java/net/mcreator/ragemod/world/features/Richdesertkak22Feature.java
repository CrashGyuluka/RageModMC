...
public class Richdesertkak22Feature extends Feature<NoneFeatureConfiguration> {
	public static final Richdesertkak22Feature FEATURE = (Richdesertkak22Feature) new Richdesertkak22Feature()
			.setRegistryName("ragemod:richdesertkak_22");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "a_rich_desert_kak2"));
		if (template == null)
			return false;
