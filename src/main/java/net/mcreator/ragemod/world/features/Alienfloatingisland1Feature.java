...
public class Alienfloatingisland1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienfloatingisland1Feature FEATURE = (Alienfloatingisland1Feature) new Alienfloatingisland1Feature()
			.setRegistryName("ragemod:alienfloatingisland_1");
	...
	public Alienfloatingisland1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "flying_island_alien_2"));
		if (template == null)
			return false;
