...
public class Glowingforestflow8Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow8Feature FEATURE = (Glowingforestflow8Feature) new Glowingforestflow8Feature()
			.setRegistryName("ragemod:glowingforestflow_8");
	...
	public Glowingforestflow8Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir8"));
		if (template == null)
			return false;
