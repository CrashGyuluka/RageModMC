...
public class Bukkfastr2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Bukkfastr2Feature FEATURE = (Bukkfastr2Feature) new Bukkfastr2Feature().setRegistryName("ragemod:bukkfastr_2");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("ragemod:beech_hill"));
	private final List<Block> base_blocks = List.of(Blocks.GRASS_BLOCK);
	private StructureTemplate template = null;

	public Bukkfastr2Feature() {
