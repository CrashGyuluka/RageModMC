...
public class Oreplus2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oreplus2Feature FEATURE = (Oreplus2Feature) new Oreplus2Feature().setRegistryName("ragemod:oreplus_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "oreplus02"));
		if (template == null)
			return false;
