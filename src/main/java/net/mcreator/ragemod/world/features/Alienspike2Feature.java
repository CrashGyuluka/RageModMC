...
public class Alienspike2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienspike2Feature FEATURE = (Alienspike2Feature) new Alienspike2Feature().setRegistryName("ragemod:alienspike_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_spike2"));
		if (template == null)
			return false;
