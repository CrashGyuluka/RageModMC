...
public class Alienstrfloor1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienstrfloor1Feature FEATURE = (Alienstrfloor1Feature) new Alienstrfloor1Feature()
			.setRegistryName("ragemod:alienstrfloor_1");
