...
public class StructportFeature extends Feature<NoneFeatureConfiguration> {
	public static final StructportFeature FEATURE = (StructportFeature) new StructportFeature().setRegistryName("ragemod:structport");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public StructportFeature() {
