...
public class GlowingFieldeTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldeTreeFeature FEATURE = (GlowingFieldeTreeFeature) new GlowingFieldeTreeFeature()
			.setRegistryName("ragemod:glowing_fielde_tree");
	...
	public GlowingFieldeTreeFeature() {
