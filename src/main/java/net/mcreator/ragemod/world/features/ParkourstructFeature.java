...
public class ParkourstructFeature extends Feature<NoneFeatureConfiguration> {
	public static final ParkourstructFeature FEATURE = (ParkourstructFeature) new ParkourstructFeature().setRegistryName("ragemod:parkourstruct");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public ParkourstructFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "struct_park"));
		if (template == null)
			return false;
