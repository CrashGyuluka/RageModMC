...
public class Glowingforestflow4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow4Feature FEATURE = (Glowingforestflow4Feature) new Glowingforestflow4Feature()
			.setRegistryName("ragemod:glowingforestflow_4");
	...
	public Glowingforestflow4Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir4"));
		if (template == null)
			return false;
