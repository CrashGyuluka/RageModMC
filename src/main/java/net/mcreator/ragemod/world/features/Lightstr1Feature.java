...
public class Lightstr1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Lightstr1Feature FEATURE = (Lightstr1Feature) new Lightstr1Feature().setRegistryName("ragemod:lightstr_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "light_str1"));
		if (template == null)
			return false;
