...
public class Glowingoaktree3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingoaktree3Feature FEATURE = (Glowingoaktree3Feature) new Glowingoaktree3Feature()
			.setRegistryName("ragemod:glowingoaktree_3");
