...
public class Glowingforestflow3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow3Feature FEATURE = (Glowingforestflow3Feature) new Glowingforestflow3Feature()
			.setRegistryName("ragemod:glowingforestflow_3");
	...
	public Glowingforestflow3Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir3"));
		if (template == null)
			return false;
