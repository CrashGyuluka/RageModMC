...
public class Bukkfastruct1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Bukkfastruct1Feature FEATURE = (Bukkfastruct1Feature) new Bukkfastruct1Feature().setRegistryName("ragemod:bukkfastruct_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if ((context.random().nextInt(1000000) + 1) <= 1000000) {
			...
			int count = context.random().nextInt(8) + 9;
