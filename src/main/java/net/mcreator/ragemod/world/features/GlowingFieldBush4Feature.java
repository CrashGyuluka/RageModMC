...
public class GlowingFieldBush4Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldBush4Feature FEATURE = (GlowingFieldBush4Feature) new GlowingFieldBush4Feature()
			.setRegistryName("ragemod:glowing_field_bush_4");
	...
	public GlowingFieldBush4Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_bush4"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 3700) {
