...
public class GlowingFieldTree3Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldTree3Feature FEATURE = (GlowingFieldTree3Feature) new GlowingFieldTree3Feature()
			.setRegistryName("ragemod:glowing_field_tree_3");
	...
	public GlowingFieldTree3Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 43000) {
