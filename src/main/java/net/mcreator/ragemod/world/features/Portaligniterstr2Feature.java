...
public class Portaligniterstr2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Portaligniterstr2Feature FEATURE = (Portaligniterstr2Feature) new Portaligniterstr2Feature()
			.setRegistryName("ragemod:portaligniterstr_2");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Portaligniterstr2Feature() {
