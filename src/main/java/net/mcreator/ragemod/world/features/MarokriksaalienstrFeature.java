...
public class MarokriksaalienstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final MarokriksaalienstrFeature FEATURE = (MarokriksaalienstrFeature) new MarokriksaalienstrFeature()
			.setRegistryName("ragemod:marokriksaalienstr");
	...
	public MarokriksaalienstrFeature() {
