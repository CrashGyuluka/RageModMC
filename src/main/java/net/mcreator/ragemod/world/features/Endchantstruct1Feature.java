...
public class Endchantstruct1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Endchantstruct1Feature FEATURE = (Endchantstruct1Feature) new Endchantstruct1Feature()
			.setRegistryName("ragemod:endchantstruct_1");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Endchantstruct1Feature() {
