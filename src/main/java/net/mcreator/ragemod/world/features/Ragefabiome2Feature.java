...
public class Ragefabiome2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ragefabiome2Feature FEATURE = (Ragefabiome2Feature) new Ragefabiome2Feature().setRegistryName("ragemod:ragefabiome_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "rage2"));
		if (template == null)
			return false;
