...
public class Glowingforestflow1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow1Feature FEATURE = (Glowingforestflow1Feature) new Glowingforestflow1Feature()
			.setRegistryName("ragemod:glowingforestflow_1");
	...
	public Glowingforestflow1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir1"));
		if (template == null)
			return false;
