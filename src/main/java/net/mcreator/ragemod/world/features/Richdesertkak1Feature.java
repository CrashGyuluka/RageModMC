...
public class Richdesertkak1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Richdesertkak1Feature FEATURE = (Richdesertkak1Feature) new Richdesertkak1Feature()
			.setRegistryName("ragemod:richdesertkak_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "a_rich_desert_kak1"));
		if (template == null)
			return false;
