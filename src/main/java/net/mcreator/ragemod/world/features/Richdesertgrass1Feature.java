...
public class Richdesertgrass1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Richdesertgrass1Feature FEATURE = (Richdesertgrass1Feature) new Richdesertgrass1Feature()
			.setRegistryName("ragemod:richdesertgrass_1");
	...
	public Richdesertgrass1Feature() {
