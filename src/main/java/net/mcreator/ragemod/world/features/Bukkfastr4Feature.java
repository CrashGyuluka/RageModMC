...
public class Bukkfastr4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Bukkfastr4Feature FEATURE = (Bukkfastr4Feature) new Bukkfastr4Feature().setRegistryName("ragemod:bukkfastr_4");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("ragemod:beech_amplified_mountain"),
			new ResourceLocation("ragemod:beech_mountain"));
	private final List<Block> base_blocks = List.of(Blocks.GRASS_BLOCK);
	private StructureTemplate template = null;

	public Bukkfastr4Feature() {
