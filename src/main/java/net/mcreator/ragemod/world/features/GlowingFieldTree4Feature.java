...
public class GlowingFieldTree4Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldTree4Feature FEATURE = (GlowingFieldTree4Feature) new GlowingFieldTree4Feature()
			.setRegistryName("ragemod:glowing_field_tree_4");
	...
	public GlowingFieldTree4Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "a_glow_oak4"));
		if (template == null)
			return false;
