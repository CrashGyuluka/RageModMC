...
public class Glowingoaktree5Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingoaktree5Feature FEATURE = (Glowingoaktree5Feature) new Glowingoaktree5Feature()
			.setRegistryName("ragemod:glowingoaktree_5");
