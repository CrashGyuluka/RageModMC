...
public class Glowingforestflow6Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow6Feature FEATURE = (Glowingforestflow6Feature) new Glowingforestflow6Feature()
			.setRegistryName("ragemod:glowingforestflow_6");
	...
	public Glowingforestflow6Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir6"));
		if (template == null)
			return false;
