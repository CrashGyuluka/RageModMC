...
public class Glowingforest3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforest3Feature FEATURE = (Glowingforest3Feature) new Glowingforest3Feature()
			.setRegistryName("ragemod:glowingforest_3");
