...
public class AlienStrFloor2Feature extends Feature<NoneFeatureConfiguration> {
	public static final AlienStrFloor2Feature FEATURE = (AlienStrFloor2Feature) new AlienStrFloor2Feature()
			.setRegistryName("ragemod:alien_str_floor_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_str_tower2"));
		if (template == null)
			return false;
