...
public class Str3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str3Feature FEATURE = (Str3Feature) new Str3Feature().setRegistryName("ragemod:str_3");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "str3"));
		if (template == null)
			return false;
