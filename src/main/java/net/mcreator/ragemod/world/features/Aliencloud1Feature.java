...
public class Aliencloud1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Aliencloud1Feature FEATURE = (Aliencloud1Feature) new Aliencloud1Feature().setRegistryName("ragemod:aliencloud_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_cloud"));
		if (template == null)
			return false;
