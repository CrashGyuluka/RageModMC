...
public class Bukkfastr11Feature extends Feature<NoneFeatureConfiguration> {
	public static final Bukkfastr11Feature FEATURE = (Bukkfastr11Feature) new Bukkfastr11Feature().setRegistryName("ragemod:bukkfastr_11");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if ((context.random().nextInt(1000000) + 1) <= 1000000) {
			...
			int count = context.random().nextInt(10) + 2;
