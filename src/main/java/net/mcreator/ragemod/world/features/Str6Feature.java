...
public class Str6Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str6Feature FEATURE = (Str6Feature) new Str6Feature().setRegistryName("ragemod:str_6");
