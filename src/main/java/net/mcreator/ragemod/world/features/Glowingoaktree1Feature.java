...
public class Glowingoaktree1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingoaktree1Feature FEATURE = (Glowingoaktree1Feature) new Glowingoaktree1Feature()
			.setRegistryName("ragemod:glowingoaktree_1");
