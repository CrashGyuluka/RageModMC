...
public class YellowcaveairstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final YellowcaveairstrFeature FEATURE = (YellowcaveairstrFeature) new YellowcaveairstrFeature()
			.setRegistryName("ragemod:yellowcaveairstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public YellowcaveairstrFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "yellowcave_air_str"));
		if (template == null)
			return false;
