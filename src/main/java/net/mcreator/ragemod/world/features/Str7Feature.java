...
public class Str7Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str7Feature FEATURE = (Str7Feature) new Str7Feature().setRegistryName("ragemod:str_7");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "a_air_relic_structure"));
		if (template == null)
			return false;
