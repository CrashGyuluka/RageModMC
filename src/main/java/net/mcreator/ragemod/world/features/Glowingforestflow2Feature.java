...
public class Glowingforestflow2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingforestflow2Feature FEATURE = (Glowingforestflow2Feature) new Glowingforestflow2Feature()
			.setRegistryName("ragemod:glowingforestflow_2");
	...
	public Glowingforestflow2Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "glowing_vir2"));
		if (template == null)
			return false;
