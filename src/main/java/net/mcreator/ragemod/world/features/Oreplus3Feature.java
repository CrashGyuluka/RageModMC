...
public class Oreplus3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oreplus3Feature FEATURE = (Oreplus3Feature) new Oreplus3Feature().setRegistryName("ragemod:oreplus_3");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "oreplus03"));
		if (template == null)
			return false;
