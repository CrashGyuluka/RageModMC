...
public class PurplehydrangeaFeature extends DefaultFlowerFeature {
	public static final PurplehydrangeaFeature FEATURE = (PurplehydrangeaFeature) new PurplehydrangeaFeature()
			.setRegistryName("ragemod:purplehydrangea");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new RandomPatchConfiguration.GrassConfigurationBuilder(
					new SimpleStateProvider(RagemodModBlocks.PURPLEHYDRANGEA.defaultBlockState()), SimpleBlockPlacer.INSTANCE).tries(5)
