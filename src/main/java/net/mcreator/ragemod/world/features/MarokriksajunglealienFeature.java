...
public class MarokriksajunglealienFeature extends Feature<NoneFeatureConfiguration> {
	public static final MarokriksajunglealienFeature FEATURE = (MarokriksajunglealienFeature) new MarokriksajunglealienFeature()
			.setRegistryName("ragemod:marokriksajunglealien");
	...
	public MarokriksajunglealienFeature() {
