...
public class BluecaveairstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final BluecaveairstrFeature FEATURE = (BluecaveairstrFeature) new BluecaveairstrFeature().setRegistryName("ragemod:bluecaveairstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public BluecaveairstrFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 23000) {
