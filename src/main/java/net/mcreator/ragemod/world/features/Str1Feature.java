...
public class Str1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Str1Feature FEATURE = (Str1Feature) new Str1Feature().setRegistryName("ragemod:str_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "str1"));
		if (template == null)
			return false;
