...
public class Glowingoaktree4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Glowingoaktree4Feature FEATURE = (Glowingoaktree4Feature) new Glowingoaktree4Feature()
			.setRegistryName("ragemod:glowingoaktree_4");
