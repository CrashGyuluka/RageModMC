...
public class GlowingFieldTree5Feature extends Feature<NoneFeatureConfiguration> {
	public static final GlowingFieldTree5Feature FEATURE = (GlowingFieldTree5Feature) new GlowingFieldTree5Feature()
			.setRegistryName("ragemod:glowing_field_tree_5");
	...
	public GlowingFieldTree5Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "a_glow_oak5"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 34000) {
