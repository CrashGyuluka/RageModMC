...
public class Ragefa1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ragefa1Feature FEATURE = (Ragefa1Feature) new Ragefa1Feature().setRegistryName("ragemod:ragefa_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 2100) {
