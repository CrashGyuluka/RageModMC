...
public class Ragefa2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ragefa2Feature FEATURE = (Ragefa2Feature) new Ragefa2Feature().setRegistryName("ragemod:ragefa_2");
