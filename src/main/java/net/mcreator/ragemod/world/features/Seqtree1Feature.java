...
public class Seqtree1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Seqtree1Feature FEATURE = (Seqtree1Feature) new Seqtree1Feature().setRegistryName("ragemod:seqtree_1");
