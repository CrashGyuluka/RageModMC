...
public class Fa3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Fa3Feature FEATURE = (Fa3Feature) new Fa3Feature().setRegistryName("ragemod:fa_3");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "kizukra_with"));
		if (template == null)
			return false;
