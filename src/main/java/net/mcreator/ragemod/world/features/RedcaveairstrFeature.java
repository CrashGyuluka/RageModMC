...
public class RedcaveairstrFeature extends Feature<NoneFeatureConfiguration> {
	public static final RedcaveairstrFeature FEATURE = (RedcaveairstrFeature) new RedcaveairstrFeature().setRegistryName("ragemod:redcaveairstr");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public RedcaveairstrFeature() {
