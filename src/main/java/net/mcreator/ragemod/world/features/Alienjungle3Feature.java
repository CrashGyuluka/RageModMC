...
public class Alienjungle3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienjungle3Feature FEATURE = (Alienjungle3Feature) new Alienjungle3Feature().setRegistryName("ragemod:alienjungle_3");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_jungle_6"));
		if (template == null)
			return false;
