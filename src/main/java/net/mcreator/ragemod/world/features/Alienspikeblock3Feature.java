...
public class Alienspikeblock3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Alienspikeblock3Feature FEATURE = (Alienspikeblock3Feature) new Alienspikeblock3Feature()
			.setRegistryName("ragemod:alienspikeblock_3");
	...
	public Alienspikeblock3Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("ragemod", "alien_spikeblock4"));
		if (template == null)
			return false;
