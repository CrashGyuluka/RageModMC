...
public class MinerEntity extends RagemodModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new BreakBlockGoal(RageiumoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(6, new BreakBlockGoal(Blocks.DIAMOND_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(7, new BreakBlockGoal(AnapaitoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(8, new BreakBlockGoal(AzuritoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(9, new BreakBlockGoal(AktinolitoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(10, new BreakBlockGoal(AdularoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(11, new BreakBlockGoal(AchatoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(12, new BreakBlockGoal(DeepslateadularoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(13, new BreakBlockGoal(DeepslateaktinolitoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(14, new BreakBlockGoal(DeepslateanapaitoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(15, new BreakBlockGoal(DeepslateachatoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(16, new BreakBlockGoal(DeepslateazuritoreBlock.block, this, 1, (int) 6));
			this.goalSelector.addGoal(17, new BreakBlockGoal(Blocks.COAL_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(18, new BreakBlockGoal(Blocks.IRON_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(19, new BreakBlockGoal(Blocks.REDSTONE_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(20, new BreakBlockGoal(Blocks.GOLD_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(21, new BreakBlockGoal(Blocks.LAPIS_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(22, new BreakBlockGoal(Blocks.EMERALD_ORE, this, 1, (int) 6));
			this.goalSelector.addGoal(23, new RandomWalkingGoal(this, 1));
			this.goalSelector.addGoal(24, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(25, new SwimGoal(this));
		}
