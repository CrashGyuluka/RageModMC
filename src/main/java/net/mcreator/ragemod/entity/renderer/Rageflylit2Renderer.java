...
@OnlyIn(Dist.CLIENT)
public class Rageflylit2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Rageflylit2Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelragefly_16(), 0.5f) {
					{
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("ragemod:textures/ragefly_texture.png")));
	...
	public static class Modelragefly_16 extends EntityModel<Entity> {
		private final ModelRenderer bb_main;
		private final ModelRenderer cube_r1;
		private final ModelRenderer cube_r2;

		public Modelragefly_16() {
			textureWidth = 16;
			textureHeight = 16;
