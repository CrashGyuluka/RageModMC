...
public class SavragerobiRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SavragerobiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltoxic_helper_16_2(), 0.5f) {
	...
	public static class Modeltoxic_helper_16_2 extends EntityModel<Entity> {
