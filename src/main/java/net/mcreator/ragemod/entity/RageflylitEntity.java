...
import net.mcreator.ragemod.entity.renderer.RageflylitRenderer;
...
public class RageflylitEntity extends RagemodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -10092493, -13434676, new Item.Properties().group(null)).setRegistryName("rageflylit_spawn_egg"));
	}
