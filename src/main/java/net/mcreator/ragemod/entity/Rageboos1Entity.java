...
public class Rageboos1Entity extends Monster {
	...
	public void aiStep() {
		...
		for (int l = 0; l < 4; ++l) {
			...
			double dx = (random.nextFloat() - 0.5D) * 0.6999999985098839D;
			double dy = (random.nextFloat() - 0.5D) * 0.6999999985098839D;
			double dz = (random.nextFloat() - 0.5D) * 0.6999999985098839D;
