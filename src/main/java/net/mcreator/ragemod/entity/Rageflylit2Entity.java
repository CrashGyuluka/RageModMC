...
import net.mcreator.ragemod.entity.renderer.Rageflylit2Renderer;
...
public class Rageflylit2Entity extends RagemodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.5f, 0.5f)).build("rageflylit_2").setRegistryName("rageflylit_2");

	public Rageflylit2Entity(RagemodModElements instance) {
		super(instance, 1321);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Rageflylit2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10092493, -13434676, new Item.Properties().group(null)).setRegistryName("rageflylit_2_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 4, 6, 15));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1.5, Ingredient.fromItems(AlienlampBlock.block.asItem()), false));
