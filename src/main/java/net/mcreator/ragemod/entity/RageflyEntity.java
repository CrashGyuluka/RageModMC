...
public class RageflyEntity extends RagemodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092493, -13434676, new Item.Properties().group(TermeszettabItemGroup.tab))
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new TemptGoal(this, 1.3, Ingredient.fromItems(AlienlampBlock.block.asItem()), false));
