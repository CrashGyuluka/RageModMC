...
import net.mcreator.ragemod.procedures.TraderrtRightClickedOnEntityProcedure;
import net.mcreator.ragemod.procedures.TraderrtOnInitialEntitySpawnProcedure;
import net.mcreator.ragemod.itemgroup.TermeszettabItemGroup;
import net.mcreator.ragemod.item.SavasfejszeItem;
import net.mcreator.ragemod.entity.renderer.TraderrtRenderer;
...
public class TraderrtEntity extends RagemodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3368704, -13424634, new Item.Properties().group(TermeszettabItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new PanicGoal(this, 0));
			this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.fromItems(SavasfejszeItem.block), false));
