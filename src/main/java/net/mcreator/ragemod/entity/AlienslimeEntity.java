...
import net.mcreator.ragemod.entity.renderer.AlienslimeRenderer;
import net.mcreator.ragemod.RagemodModElements;

@RagemodModElements.ModElement.Tag
public class AlienslimeEntity extends RagemodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -6750055, new Item.Properties().group(TermeszettabItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("ragemod:alien_forest").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("ragemod:alien_lake").equals(event.getName()))
			biomeCriteria = true;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(AlienfoodItem.block));
		}
