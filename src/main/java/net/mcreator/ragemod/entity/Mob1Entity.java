...
public class Mob1Entity extends RagemodModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724941, -14072293, new Item.Properties().group(ErcekItemGroup.tab))
...
>>>>>>> branch 'master' of https://github.com/CrashGyuluka/RageModMc.git
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, AlienMobEntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, AtomRageREntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, AlienMobEntity.CustomEntity.class, false, false));
			this.goalSelector.addGoal(5, new MeleeAttackGoal(this, 1.2, false));
