...
public class OnPlayerUpdateTickAlieniteShieldProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				RagemodMod.LOGGER.warn("Failed to load dependency entity for procedure OnPlayerUpdateTickAlieniteShield!");
			return;
		}
