...
public class HangingalienplantUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == HangingalienplantBlock.block) || (((world
				.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == HangingalienplantdevblockBlock.block)
				|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Hangingalienoff1Block.block) || (((world
						.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Hangingalienplant3Block.block)
						|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Haningalienplant5Block.block)
								|| (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Hangingalienplant5Block.block)
										|| ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z)))
												.getBlock() == Hangingalienplantexluse1Block.block)))))))) {
			if (((((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == HangingalienplantBlock.block) || (((world
					.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == HangingalienplantdevblockBlock.block)
					|| (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Hangingalienoff1Block.block)
							|| (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Hangingalienplant3Block.block)
									|| (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z)))
											.getBlock() == Haningalienplant5Block.block)
											|| (((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z)))
													.getBlock() == Hangingalienplant5Block.block)
													|| ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z)))
															.getBlock() == Hangingalienplantexluse1Block.block)))))))
