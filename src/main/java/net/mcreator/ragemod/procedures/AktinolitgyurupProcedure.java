...
public class AktinolitgyurupProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				RagemodMod.LOGGER.warn("Failed to load dependency entity for procedure Aktinolitgyurup!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (AktinolitgyuruItem.block == ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()
				&& entity.isSneaking()) {
