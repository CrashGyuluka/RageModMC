...
public class SequoiaspalingrightclickedProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == RagemodModBlocks.SEQUOIA_SAPLING) {
			{
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("ragemod", "seq_tree1"));
				if (template != null) {
					template.placeInWorld(_serverworld, new BlockPos((int) (x - 6), (int) y, (int) (z - 6)),
							new BlockPos((int) (x - 6), (int) y, (int) (z - 6)),
