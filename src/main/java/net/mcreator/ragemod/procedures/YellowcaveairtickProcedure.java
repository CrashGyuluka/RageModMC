	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getMaterial() == net.minecraft.block.material.Material.AIR) {
			if (Blocks.STONE == (world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock()) {
				...
				if ((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == YellowcavestoneBlock.block) {
					if (0.13 >= Math.random()) {
						if (0.5 >= Math.random()) {
							world.setBlockState(new BlockPos((int) x, (int) y, (int) z), YellowcavemushroomBlock.block.getDefaultState(), 3);
						} else {
							if (0.6 >= Math.random()) {
								world.setBlockState(new BlockPos((int) x, (int) y, (int) z), YellowGlowingCavemushroomBlock.block.getDefaultState(),
										3);
							} else {
								world.setBlockState(new BlockPos((int) x, (int) y, (int) z), YellowCaveTrapBlock.block.getDefaultState(), 3);
							}
						}
