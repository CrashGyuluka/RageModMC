	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RagemodMod.LOGGER.warn("Failed to load dependency x for procedure SavasrageiumalloyblockOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RagemodMod.LOGGER.warn("Failed to load dependency y for procedure SavasrageiumalloyblockOnBlockRightClicked!");
			return;
		}
		...
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RagemodMod.LOGGER.warn("Failed to load dependency world for procedure SavasrageiumalloyblockOnBlockRightClicked!");
			return;
		}
