							...
							if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Strhatarolo4Block.block) {
								...
								if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Strhatarolo5Block.block) {
									...
									if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Strhatarolo6Block.block) {
										...
										if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Strblock7Block.block) {
											if (Math.random() < 0.4) {
												{
													BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
													BlockState _bs = AlienPlantTrapBlock.block.getDefaultState();
													world.setBlockState(_bp, _bs, 3);
												}
											} else {
												{
											...
											if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == StrBlock8Block.block) {
												if (Math.random() < 0.4) {
													{
														BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
														BlockState _bs = AliencobwebBlock.block.getDefaultState();
														world.setBlockState(_bp, _bs, 3);
													}
												} else {
													{
