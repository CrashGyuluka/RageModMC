...
import net.mcreator.ragemod.procedures.ConverterSlotChangesProcedure;
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 6) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (OpalItem.block == stack.getItem());
				}
			}));
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 24, 19) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (RageiumItem.block == stack.getItem());
				}
			}));
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 88, 43) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (SavercrItem.block == stack.getItem());
				}
			}));
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				RagemodMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
