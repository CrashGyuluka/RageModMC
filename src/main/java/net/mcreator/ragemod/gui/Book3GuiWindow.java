...
public class Book3GuiWindow extends ContainerScreen<Book3Gui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.guiLeft + 7, this.guiTop + 22, 0, 0, -1, -1, -1, -1);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 159, this.guiTop + 5, 50, 20, new StringTextComponent("ELÕZÕ"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 139, this.guiTop + 37, 70, 20, new StringTextComponent("KÖVETKEZÕ"), e -> {
			if (true) {
